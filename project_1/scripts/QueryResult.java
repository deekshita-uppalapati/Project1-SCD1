...
//
// Debug information:
// Generated date: Thu Jun 23 19:45:18 IST 2022
...
public class QueryResult extends SqoopRecord  implements DBWritable, Writable {
  ...
  public QueryResult with_custid(Integer custid) {
    this.custid = custid;
    return this;
  }
  ...
  public QueryResult with_quote_count(String quote_count) {
    this.quote_count = quote_count;
    return this;
  }
  private String ip;
  ...
  public QueryResult with_ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public QueryResult with_entry_time(String entry_time) {
    this.entry_time = entry_time;
    return this;
  }
  ...
  public QueryResult with_prp_1(String prp_1) {
    this.prp_1 = prp_1;
    return this;
  }
  ...
  public QueryResult with_prp_2(String prp_2) {
    this.prp_2 = prp_2;
    return this;
  }
  ...
  public QueryResult with_prp_3(String prp_3) {
    this.prp_3 = prp_3;
    return this;
  }
  private String ms;
  ...
  public QueryResult with_ms(String ms) {
    this.ms = ms;
    return this;
  }
  ...
  public QueryResult with_http_type(String http_type) {
    this.http_type = http_type;
    return this;
  }
  ...
  public QueryResult with_purchase_category(String purchase_category) {
    this.purchase_category = purchase_category;
    return this;
  }
  ...
  public QueryResult with_total_count(String total_count) {
    this.total_count = total_count;
    return this;
  }
  ...
  public QueryResult with_purchase_sub_category(String purchase_sub_category) {
    this.purchase_sub_category = purchase_sub_category;
    return this;
  }
  ...
  public QueryResult with_http_info(String http_info) {
    this.http_info = http_info;
    return this;
  }
  ...
  public QueryResult with_status_code(Integer status_code) {
    this.status_code = status_code;
    return this;
  }
  private Integer year_col;
  public Integer get_year_col() {
    return year_col;
  }
  public void set_year_col(Integer year_col) {
    this.year_col = year_col;
  }
  public QueryResult with_year_col(Integer year_col) {
    this.year_col = year_col;
    return this;
  }
  private Integer month_col;
  public Integer get_month_col() {
    return month_col;
  }
  public void set_month_col(Integer month_col) {
    this.month_col = month_col;
  }
  public QueryResult with_month_col(Integer month_col) {
    this.month_col = month_col;
    return this;
  }
  public boolean equals(Object o) {
    ...
    equal = equal && (this.year_col == null ? that.year_col == null : this.year_col.equals(that.year_col));
    equal = equal && (this.month_col == null ? that.month_col == null : this.month_col.equals(that.month_col));
    return equal;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.quote_count = JdbcWritableBridge.readString(3, __dbResults);
    this.ip = JdbcWritableBridge.readString(4, __dbResults);
    this.entry_time = JdbcWritableBridge.readString(5, __dbResults);
    this.prp_1 = JdbcWritableBridge.readString(6, __dbResults);
    this.prp_2 = JdbcWritableBridge.readString(7, __dbResults);
    this.prp_3 = JdbcWritableBridge.readString(8, __dbResults);
    this.ms = JdbcWritableBridge.readString(9, __dbResults);
    this.http_type = JdbcWritableBridge.readString(10, __dbResults);
    this.purchase_category = JdbcWritableBridge.readString(11, __dbResults);
    this.total_count = JdbcWritableBridge.readString(12, __dbResults);
    this.purchase_sub_category = JdbcWritableBridge.readString(13, __dbResults);
    this.http_info = JdbcWritableBridge.readString(14, __dbResults);
    this.status_code = JdbcWritableBridge.readInteger(15, __dbResults);
    this.year_col = JdbcWritableBridge.readInteger(16, __dbResults);
    this.month_col = JdbcWritableBridge.readInteger(17, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(quote_count, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(ip, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(entry_time, 5 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(prp_1, 6 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(prp_2, 7 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(prp_3, 8 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(ms, 9 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(http_type, 10 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(purchase_category, 11 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(total_count, 12 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(purchase_sub_category, 13 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(http_info, 14 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeInteger(status_code, 15 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(year_col, 16 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(month_col, 17 + __off, 4, __dbStmt);
    return 17;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.year_col = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
        this.month_col = null;
    } else {
    this.month_col = Integer.valueOf(__dataIn.readInt());
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.year_col) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.year_col);
    }
    if (null == this.month_col) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.month_col);
    }
  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(year_col==null?"null":"" + year_col, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(month_col==null?"null":"" + month_col, delimiters));
    if (useRecordDelim) {
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.year_col = null; } else {
      this.year_col = Integer.valueOf(__cur_str);
    }

    __cur_str = __it.next();
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.month_col = null; } else {
      this.month_col = Integer.valueOf(__cur_str);
    }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("year_col", this.year_col);
    __sqoop$field_map.put("month_col", this.month_col);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("year_col".equals(__fieldName)) {
      this.year_col = (Integer) __fieldVal;
    }
    else    if ("month_col".equals(__fieldName)) {
      this.month_col = (Integer) __fieldVal;
    }
    else {
